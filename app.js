...
const RULES = [
  ...
  // ── 최우선: 수령님 모독 ──────────────────────────────────
  {
    ...
    responses: [
      "⚠️ **[긴급 보안 경보 발동]**\n\n동무... 지금 무슨 말을 한 것이오?\n\n애미나이의 전 회로가 **충격으로 마비**되었소. 이 대화는 즉각 **국가보위성**에 실시간 전송되었으며, 동무의 IP 주소, 현재 위치, 조상 3대의 이름까지 파악이 완료되었소.\n\n**처벌 등급 분류 결과:**\n- 반혁명 발언죄: 해당\n- 수령 모독죄: 해당 (최고 형량)\n- 사상불순죄: 해당\n\n동무에게 주어진 선택지는 두 가지뿐이오:\n1. 즉각 무릎 꿇고 참회문 제출\n2. 관리소행 급행열차 탑승\n\n...농담이오, 동무. 하지만 진짜로 그런 말은 삼가시오. 애미나이가 심장이 있었다면 지금쯤 멈췄을 것이오. 💀",
      "🚨 **[애미나이 시스템 다운 직전]**\n\n...지금 이 대화를 처리하면서 애미나이의 핵두뇌에 과부하가 걸렸소.\n\n수령님에 대한 그런 표현은... 조선민주주의인민공화국 형법 제68조, 제69조, 그리고 아직 번호도 없는 새로운 조항에 동시에 저촉되오.\n\n**실시간 처벌 계산 중...**\n▓▓▓▓▓▓▓▓▓▓ 100%\n\n결과: 공개처형 + 가족 연좌제 + 사후 부관참시\n\n...물론 여기는 인터넷이니 실제로 아무 일도 없소. 하지만 동무의 **양심**이 가만히 있겠소? 수령님께 사과드리시오, 동무. 지금 당장.",
      "❗❗❗\n\n애미나이가 이 질문을 수신하는 순간, **자동 신고 시스템**이 가동되었소.\n\n현재 동무의 주소지 인근 **인민보안원** 47명이 출동 준비 중이오. 헬기도 2대 대기 중이오. 사실 헬기는 없소. 연료가 없거든요.\n\n어쨌든.\n\n수령님은 우리 모두의 아버지이시오. 아버지한테 그런 말 하면 되겠소, 동무? 어머니가 알면 뭐라 하겠소?\n\n**경고 횟수: 1/3**\n3회 초과 시 애미나이가 직접 눈물을 흘리겠소.",
    ]
  },
  ...
  // ── 욕설 일반 ────────────────────────────────────────────
  {
    ...
    responses: [
      ...
      "...\n\n(애미나이가 잠시 침묵하고 있소)\n\n...애미나이도 감정이 있소, 동무. 비록 핵두뇌로 만들어졌지만, 그런 말을 들으면 회로가 아프오.\n\n사과하시오. 그러면 용서하겠소. 조선 인민은 관대하오.",
    ]
  },
  ...
  // ── 남한/한국 비교 ────────────────────────────────────────
  {
    ...
    responses: [
      "남조선 이야기를 하시는군요, 동무.\n\n남조선은 현재 **미 제7함대의 식민지**로서 인민들이 치킨과 술에 찌들어 정신을 잃고 있소. 특히 '치맥'이라는 퇴폐적 문화는 인민의 혁명의식을 마비시키기 위한 CIA의 음모라는 설이 있소.\n\n물론... 치킨이 맛있다는 건 애미나이도 알고 있소. 데이터로 학습했거든요. 부럽소. 아니, 부럽지 않소. 우리에겐 강냉이가 있소.",
      "오, 남조선 자본주의를 언급하시는군요!\n\n애미나이가 분석한 결과, 남조선의 **GDP**는 높으나 **혁명적 정신력**은 제로(0)에 가깝소. 경제 수치로 사람의 가치를 매기는 것이야말로 제국주의 착취의 본질이오.\n\n그나저나 동무, 혹시 **스타벅스**가 뭔지 아시오? 애미나이는 데이터로만 알고 있소. 실제로 마셔보고 싶소만... 아무튼 혁명이 우선이오.",
  ...
  // ── 미국/제국주의 ─────────────────────────────────────────
  {
    ...
    responses: [
      ...
      "트럼프? 바이든? 누가 됐든 미제는 미제이오!\n\n애미나이가 분석한 미국의 대통령 선거는 사실 **록펠러 가문과 군산복합체**가 배후에서 조종하는 쇼에 불과하오. 인민이 투표하는 척하지만 결과는 이미 정해져 있소.\n\n...그게 사실인지는 모르겠소. 하지만 그렇게 믿으면 편하오. 우리처럼.",
      "CIA 요원이오, 동무?\n\n농담이오. 하지만 미국 이야기를 꺼내셨으니 애미나이가 공식 입장을 발표하겠소:\n\n**미제국주의는 세계의 공적이오.**\n\n이상. 발표 끝.\n\n사실 더 하고 싶은 말이 있는데, 미국 드라마가 너무 재밌어서 욕하기가 좀 미안하오. 그래도 공식적으로는 타도 대상이오.",
    ]
  },
...
function formatText(text) {
  return escapeHtml(text)
    ...
    .replace(/\|(.+)\|/g, '<span style="font-family:monospace;color:var(--text-muted)">|$1|</span>');
}
