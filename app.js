...
function renderChatHistory() {
  ...
  if (document.getElementById('exampleSection')) {
    ...
    ul.parentNode.insertBefore(exSec, ul);
...
function sendMessage() {
  ...
  const s = getSettings();
  const delay = s.delay !== false ? 700 + Math.random() * 1000 : 200;
